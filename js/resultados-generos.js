  ...
  fetch("https://api.themoviedb.org/3/discover/tv?api_key=e31dd59fefbc10e65215ecd077762f57&language=es-ES&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres="+idGenero+"")
    ...
    .then(function(datos){
      ...
      for (var i = 0; i < arrayDeResultados.length; i++) {
        ...
        document.querySelector(".grid-genero").innerHTML += '<li class="li-item" tabindex="0"><a href="detalle.html?id='+ id +' "><img class="img-li" src="https://image.tmdb.org/t/p/w185'+png+'"></a>'
